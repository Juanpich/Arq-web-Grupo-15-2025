package org.example.iaagentservice.clients;
...
public class GroqClient {
    ...
    public GroqClient(
        ...
        if (apiKey == null || apiKey.isBlank()) {
            throw new IllegalStateException("GROQ API key nula o en blanco. Revisar GROQ_API_KEY o -Dgroq.api-key.");
        }
        if (!apiKey.startsWith("gsk_")) {
            throw new IllegalStateException("GROQ API key con formato invalido. Tiene que empezar con gsk_.");
        }
        ...
        this.rest.setErrorHandler(new DefaultResponseErrorHandler() {
            public void handleError(ClientHttpResponse response) throws IOException {
                // Los errores 4xx y 5xx suben con el cuerpo para logearlo
    ...
    public String ask(String prompt) {
        ...
        headers.setBearerAuth(apiKey); // CLAVE ACA
